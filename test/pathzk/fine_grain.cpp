...
void test_circuit_zk(BoolIO<NetIO> *ios[threads], int party, size_t branch_size, size_t reg_size, size_t step, size_t cir_size) {
    ...
    auto end1 = time_from(start1);	
	cout << "Time for committing l,r,o,in and o = lr: " << end1 << " us\t" << party << " " << endl;
    ...
    auto end2 = time_from(start2);	
	cout << "Time for committing p,id: " << end2 << " us\t" << party << " " << endl;    
    ...
    auto end3 = time_from(start3);	
	cout << "Time for setting init urom: " << end3 << " us\t" << party << " " << endl;         
    ...
    auto end4 = time_from(start4);	
	cout << "Time for read urom: " << end4 << " us\t" << party << " " << endl;         


    auto start5 = clock_start();
    ...
    auto end5 = time_from(start5);	
	cout << "Time for set prog urom: " << end5 << " us\t" << party << " " << endl;             

    // ZKUROM (tail-heavy)

    auto start6 = clock_start();
    ...
    auto end6 = time_from(start6);	
	cout << "Time for check last is 0 in urom: " << end6 << " us\t" << party << " " << endl;         

    auto start7 = clock_start();
    ...
    auto end7 = time_from(start7);	
	cout << "Time for init rom: " << end7 << " us\t" << party << " " << endl;         

    auto start8 = clock_start();
    for (int i = 0; i < path_length; i++) mac[i] = macrom.Access(id[i]);
    auto end8 = time_from(start8);	
	cout << "Time for read rom: " << end8 << " us\t" << party << " " << endl;      

    auto start9 = clock_start();
    macrom.Teardown_Batch_Public(party, 16);
    std::cout << "[Check]: zkrom is performed correctly" << std::endl;
    auto end9 = time_from(start9);	
	cout << "Time for check rom: " << end9 << " us\t" << party << " " << endl;      

    auto start10 = clock_start();
    ...
    auto end10 = time_from(start10);	
	cout << "Time for check urom: " << end10 << " us\t" << party << " " << endl;      


    auto start11 = clock_start();
    ...
    auto end11 = time_from(start11);	
	cout << "Time for checking checking output: " << end11 << " us\t" << party << " " << endl;          
